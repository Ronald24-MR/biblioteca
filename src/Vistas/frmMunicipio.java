...
import VistasEdit.Editarmunicipio;
...
public class frmMunicipio extends javax.swing.JFrame {
    ...
    public frmMunicipio() {
        ...
        this.setTitle("Formulario Municipio");
    }
    ...
    public void cargarTabla(int codigo){
        ...
        Municipio ciudad = mn.findMunicipio(codigo);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Editarmunicipio em = new Editarmunicipio(new JFrame(),true);
        em.setVisible(true);
