...
import VistasEdit.Editartipodepago;
...
TipoPagoJpaController tp=new TipoPagoJpaController();
    ...
    public frmTipoPago() {
        initComponents();
        Cargartabla();
        this.setTitle("Formulario Tipo Pago");
    ...
    public void cargarTabla(int codigo){
        ...
        TipoPago ciudad = tp.findTipoPago(codigo);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Editartipodepago et = new Editartipodepago(new JFrame(),true);
        et.setVisible(true);
