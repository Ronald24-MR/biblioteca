...
import VistasEdit.Editarvigencia;
 ...
 * @author Ronald
 */
public class frmVigencia extends javax.swing.JFrame {
 VigenciaJpaController  vg=new VigenciaJpaController();
    /**
     * Creates new form frmVigencia
     */
    public frmVigencia() {
        initComponents();
        Cargartabla();
        this.setTitle("Formulario Vigencia");
    ...
    public void cargarTabla(int codigo){
        ...
        Vigencia ciudad = vg.findVigencia(codigo);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else
        {
            ...
            vigencia.setCodigo(codigo);
            vigencia.setNombre(nombres);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Editarvigencia ev = new Editarvigencia(new JFrame(),true);
        ev.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVigencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVigencia().setVisible(true);
            }
        });
    }
